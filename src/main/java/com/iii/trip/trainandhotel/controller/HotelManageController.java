...
public class HotelManageController {
	...
	public String insert(@ModelAttribute HotelForm reqForm, BindingResult bindingResult, RedirectAttributes redirectAttributes ) {
		//String userId = Utility.getStringNotNull(mb.getUserid());
		String userId = "a123";
	...
	@ResponseBody
	public String delete(@RequestParam("id") String id, @RequestParam("reason") String reason) {
...
//			hotelRepo.deleteById(hotel.getId());
			...
			//String userEmail = Utility.getStringNotNull(mb.getEmail());
			  String userEmail ="kanade8655@gmail.com"; 
	...
	public String resultHotel(Model model, @RequestParam("key") String key) {
		//String userId = Utility.getStringNotNull(mb.getUserid());
		String userId = "a123";
